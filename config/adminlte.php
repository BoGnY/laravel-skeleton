...
return [
    ...
    */
    ...
    'logo_img' => 'https://raw.githubusercontent.com/ColorlibHQ/AdminLTE/master/dist/img/AdminLTELogo.png',
    ...
    */
    ...
    'logout_url' => 'logout',
    'logout_method' => null, // Available options: GET, POST & null (Laravel default)
    'login_url' => 'login',
    ...
    |
    */
    'enabled_laravel_mix' => false, //UNNECESSARY
        ...
        [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => 'https://cdnjs.cloudflare.com/ajax/libs/pace/1.0.2/themes/blue/pace-theme-flash.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
